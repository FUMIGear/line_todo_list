...
Rails.application.configure do
  ...
  # config.hosts << "61d0-103-5-140-173.ngrok-free.app" # 書き方が変わってる。
  # config.hosts << ["61d0-103-5-140-173.ngrok-free.app", "localhost"]  #これなら、ホスト名を指定できる。
  config.hosts << "line-todo-list.onrender.com"  #Render.com用
  # config.hosts.clear # 推奨しない設定（誰でもOK状態）
end
